...
parser.add_argument('--tau_m', type=float, default=160, help='Time constant of membrane potential kernel [ms]')
parser.add_argument('--tau_s', type=float, default=40, help='Time constant of synaptic current kernel [ms]')
